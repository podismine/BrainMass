...
def get_data(args):
    if args.data == 'abide1':
        ...
        args.csv = "down_stream/oas.csv"
    elif args.data == 'mci':
        args.csv = "down_stream/mci.csv"
    elif args.data == 'ad':
        args.csv = "down_stream/ad.csv"
    elif args.data == 'pd':
        args.csv = "down_stream/pd.csv"
    elif args.data == 'pro':
        args.csv = "down_stream/pro.csv"
    elif args.data =='schizo':
        args.csv = "down_stream/schizo.csv"
    elif args.data == 'abide2':
        args.csv = "down_stream/abide2.csv"
    elif args.data == 'ucla_bp':
        args.csv = "down_stream/ucla_bp.csv"
    elif args.data == 'ucla_schizo':
        args.csv = "down_stream/ucla_schz.csv"
    elif args.data == 'ucla_adhd':
        args.csv = "down_stream/ucla_adhd.csv"
    elif args.data == 'xuanwu_pd':
        args.csv = "down_stream/xuanwu_pd.csv"
    elif args.data == 'xuanwu_rbd':
        args.csv = "down_stream/xuanwu_rbd.csv"
    elif args.data == 'pd_ad':
        args.csv = "down_stream/pd_ad.csv"
    return args
...
def load_state_dict(model, state_dict, prefix='', ignore_missing="relative_position_index"):
    ...
    #print("loading state_dict: ", state_dict.keys());exit()
